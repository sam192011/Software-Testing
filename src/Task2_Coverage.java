...
public class Task2_Coverage {
	...
	// Testing Parser.getChar()

	@Test
	public void GetCharEmptyString() {
		parser.add("character", "c", Parser.CHAR);
		parser.parse("-c 'a'");
		assertEquals(parser.getChar("c"), 'a');
	}

	// Testing Parser.getInteger()

	@Test
	public void getIntegerCorrect() {
	...
	@Test
	public void getIntegerBigInteger() {
		parser.add("Integer", "i", Parser.INTEGER);
		parser.parse("-i 2147483648");
		assertEquals(parser.getInteger("i"), 0);
	}

	@Test
	public void getIntegerNegativeBigInteger() {
		parser.add("Integer", "i", Parser.INTEGER);
		parser.parse("-i -2147483648");
		assertEquals(parser.getInteger("i"), 0);
	}
	...
	@Test
	public void getIntegerBooleanFalse() {
		parser.add("Integer", "i", Parser.BOOLEAN);
		parser.parse("-i false");
		assertEquals(parser.getInteger("i"), 0);
	}

	@Test
	public void getIntegerBooleanTrue() {
		parser.add("Integer", "i", Parser.BOOLEAN);
		parser.parse("-i true");
		assertEquals(parser.getInteger("i"), 1);
	}
	...
	public void getIntegerChar() {
		parser.add("character", "c", Parser.CHAR);
		parser.parse("-c a");
		assertEquals(parser.getInteger("c"), (int)'a');
	}
